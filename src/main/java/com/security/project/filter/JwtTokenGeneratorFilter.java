...
import com.security.project.constants.AppConstants;
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        if(authentication != null) {
            ...
            if(env != null) {
                ...
                String jwt = Jwts.builder().issuer("Bank app").subject("JWT Token")
                    // Sotring uName and authorities in payload of jwt
